...
CMD ["-d", "-e", "anygenre2.jamulus.io:22224", "-F", "-n", "-o", "├ DaGarage Online ┤;Asbury Park, NJ;us", "-P", "-R", "/Jamulus/Recordings/Public", "-s", "-T", "-u", "14", "-w", "/Jamulus/Web/motd-jamulus-public.htm", "-Q", "46", "-p", "22124"]
